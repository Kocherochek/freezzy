...
/// Тип рецепта. meal — обычное блюдо для дневного меню.
/// prep — рецепт заготовки: на выходе не "съел и всё", а партия
/// BasePrep, которая уезжает на склад. Рецепты типа prep исключаются
/// из обычной генерации дневного меню и генерируются отдельно.
enum RecipeType { meal, prep }